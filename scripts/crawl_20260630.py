...
from scripts.database import (
    ...
    save_attachment, save_crawl_result,
)
from scripts.storage import upload_file

QUERY = "in:inbox after:2026/06/29 before:2026/07/01 has:attachment"
...
def run():
    ...
    print(f"\nComplete! New emails: {new_email_count}, New files: {new_file_count}")
